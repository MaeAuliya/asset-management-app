    ...
    return base.copyWith(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: const BorderSide(color: Colours.blueStroke),
        ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: _border(Colours.blueStroke, 20),
        enabledBorder: _border(Colours.blueStroke, 20),
        focusedBorder: _border(colorScheme.primary, 20, width: 1.4),
        errorBorder: _border(Colours.errorColor, 20),
        focusedErrorBorder: _border(Colours.errorColor, 20, width: 1.4),
      ),
      chipTheme: base.chipTheme.copyWith(
        color: const WidgetStatePropertyAll(Colours.white),
        side: const BorderSide(color: Colours.blueStroke),
        labelStyle: const TextStyle(color: Colours.blueInk),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        elevation: 0,
        height: 78,
        indicatorColor: Colours.blueSurfaceStrong,
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          final selected = states.contains(WidgetState.selected);
          return TextStyle(
            color: selected ? Colours.primaryBlue : Colours.gray500,
